        ...
        with torch.no_grad():
            ...
            if 'concept' in current_entry and current_entry['concept'] is not None:
                if isinstance(current_entry['concept'], str):
                    ...
                    concept_text_embeddings = model.encode_text(
                        texts=current_entry['concept'],
                        task="retrieval",
                        prompt_name="query",
                    )
                    concept_text_embeddings = concatenate_tensors(concept_text_embeddings)
                    ...
                    text_embeddings_dict['translated_concept_embedding'] = model.encode_text(
